...
export type SnapshotWhereInput = {
  ...
  aggregateId?: Prisma.StringFilter<"Snapshot"> | string
...
export type SnapshotScalarWhereWithAggregatesInput = {
  ...
  aggregateId?: Prisma.StringWithAggregatesFilter<"Snapshot"> | string
...
export type SnapshotOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "aggregateId" | "version" | "state", ExtArgs["result"]["snapshot"]>
